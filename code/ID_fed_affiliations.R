  ...
  affils_df <- affils_df %>%
    mutate(agency_short = case_when(
      ...
      affil_id %in% c(
        ...
        132054792, 132763981, 121697292,
        110231280, 114358001, 116351316,
        118763835, 118990068, 124072602, 124899230,
        125021094, 125947150, 127251082, 127808105,
