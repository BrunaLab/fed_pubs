ID_univ_affiliations <- function(affils_df) {
  ...
  uni_affils<-read_csv("./data_clean/uni_affils_clean.csv") %>% 
    mutate_all(tolower) %>% 
  ...
  affils_df<-left_join(affils_df,uni_affils,by=c("affil_id","city","country","affiliation")) %>% 
...
#   
#   harvard <- as_tibble(c(
#   "60009982", "60097058", "60001001", "60023563", "60079465",
...
# )) %>%
#   mutate(univ = "harvard") %>% 
#   mutate(affil_code = 191469) %>% 
#   mutate(inst_code = 726046)  
#   
# michigan <- as_tibble(c(
#   "60033182", "60025778", "60073999", "60009933", "60155336", "60155338",
...
# )) %>%
#   mutate(univ = "michigan") %>% 
# mutate(affil_code = 347907) %>% 
#   mutate(inst_code =418348 ) 
# 
# 
# washington <- as_tibble(c(
#   "60028548", "60015481", "60156837", "60011986", "60292186", "60116364",
...
# )) %>%
#   mutate(univ = "washington") %>% 
#   mutate(affil_code =329371 ) %>% 
#   mutate(inst_code = 373766) 
# 
# 
# 
# penn <- as_tibble(c(
#   "60107840", "60271725", "60073168", "60138958",
...
#   "60102563", "60022452", "60156403", "60006297"
# )) %>%
#   mutate(univ = "penn") %>% 
#   mutate(affil_code =269101 ) %>% 
#   mutate(inst_code =368273 ) 
# 
# 
# 
# 
# stanford <- as_tibble(c(
#   "60012708", "60032838", "60075286", "60026163", "60091251", "60122630",
...
#   "60141701"
# )) %>%
#   mutate(univ = "stanford") %>% 
#   mutate(affil_code =306475 ) %>% 
#   mutate(inst_code = 416740) 
# 
# 
# 
# 
# 
# ucla <- as_tibble(c(
#   "60027550", "60016081", "60117623", "60102435", "60085729",
...
#   "60138295"
# )) %>% mutate(univ = "ucla") %>% 
#   mutate(affil_code =312016 ) %>% 
#   mutate(inst_code = 392573) 
# 
# 
# 
# 
...
# 
# 
# mass_general <- as_tibble(c("60026147", "60007377", "60102779", "60029929", "60008130", "60159760")) %>%
#   mutate(univ = "mass_general") %>% 
#   mutate(affil_code =209891 ) %>% 
#   mutate(inst_code =215786 ) 
# 
# 
# 
# 
# ucsf <- as_tibble(c(
#   "60023691", "60031970", "60076081", "60226504", "60120814", "60008261",
...
# )) %>%
#   mutate(univ = "ucsf") %>% 
#   mutate(affil_code =241713 ) %>% 
#   mutate(inst_code = 265358) 
# 
# 
# 
# 
...
# 
# florida <- as_tibble(c(
#   "60013959", "60138923", "60154289", "60154389", "60027033",
...
#   "60004181", "60030502", "60017574", "60122769", "60013959"
# )) %>%
#   mutate(univ = "florida") %>% 
#   mutate(affil_code =245598 ) %>% 
#   mutate(inst_code =283685 ) 
# 
# 
# 
# 
# ucsd <- as_tibble(c(
#   "60030612", "60121553", "60121641", "60121557", "60121643",
...
# )) %>%
#   mutate(univ = "ucsd") %>% 
#   mutate(affil_code = 264376) %>% 
#   mutate(inst_code = 288722) 
# 
# univ_affils<-bind_rows(
# florida,
# harvard,
# mass_general,
# michigan,
