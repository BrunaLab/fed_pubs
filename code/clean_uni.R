...
message("STEP 1/6: loading the files of papers, affiliations, and authors...")
...
#     )
#   }, error = function(e) {
#     message("STEP 1: Error retrieving data for affil_id: ", query_string)
#     return(NULL)
#   })
#   
#   
...
# duplicates --------------------------------------------------------------
  ...
  message("STEP 4/6: checking for duplicates...")
...
# make sure articles have an author from focal uni ------------------------

  
  
  
  message("STEP 5/6: making sure articles have at least 1 author from focal university (this takes a while)...")
...
# SAVE CLEAN FILES --------------------------------------------------------
  ...
  message("STEP 6/6: saving cleaned-up files...")
