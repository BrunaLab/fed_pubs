...
# 
data_dir<-"./data_raw/scopus_api/usgs"
...
# save --------------------------------------------------------------------
  ...
  # # FOR WITHIN YEAR BINDING - USGS
  # 
  write_csv(affils_df,paste("./data_raw/affils/year_files_fed/affils_df_usgs",".csv",sep=""))
  write_csv(authors_df,paste("./data_raw/authors/year_files_fed/authors_df__usgs",".csv",sep=""))
  write_csv(papers_df,paste("./data_raw/papers/year_files_fed/papers_df__usgs",".csv",sep=""))

  
  write_csv(incompletes_to_remove,paste("./data_raw/incomplete_records_removed/usgs/incompletes_removed_",".csv",sep=""))
