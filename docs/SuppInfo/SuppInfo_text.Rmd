...
bs_stats<-read_csv(paste(fed_dir,"bs_stats_all.csv",sep="/"))
...
uni_auth_per_pub_means<-read_csv(paste(uni_dir,"uni_auth_per_pub_means.csv",sep="/"))
...
papers_by_cat_agency<-read_csv(paste(uni_dir,"papers_by_cat_agency.csv",sep="/"))
