...
```{r  label = pubs-monthly-fed, echo = FALSE, fig.cap = "Articles by federal government agency's indexed per month (2019-2024).", out.width = '50%',out.width = '70%', fig.align='center'}
...
# uni_pubs_table<-rbind(uni_pubs_table,totals)
  ...
  add_header_above(c(" " = 1, "No. of Pulications" = 2)) %>%
  ...
  #          general="The sum of publications in this column is greater than the total number of publications in our dataset because some publications include authors from multiple focal instituions (i.e., we did not attribute 'fractional authorship')."
    footnote(number=c("The sum of publications in this column is greater than the total number of publications in our dataset because some publications include authors from multiple focal instituions (i.e., we did not attribute 'fractional authorship')."),
