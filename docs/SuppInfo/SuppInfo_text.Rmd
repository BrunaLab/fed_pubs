...
bs_stats<-read_csv(paste(fed_dir,"bs_stats_all_fed.csv",sep="/"))
...
total_papers_by_uni<-read_csv(paste(uni_dir,"total_papers_by_uni.csv",sep="/")) %>% 
  filter(!is.na(uni))
...
knitr::include_graphics(paste('.',fed_dir,"/pubs_per_month.png",sep=""),error=FALSE)
...
knitr::include_graphics(paste('.',fed_dir,"/bs_composite_fig.png",sep=""),error=FALSE)
...
knitr::include_graphics(paste('.',uni_dir,"/bs_composite_fig_uni.png",sep=""),error=FALSE)
...
knitr::include_graphics(paste('.',uni_dir,"/pubs_mo_cum_uni_lines.png",sep=""),error=FALSE)
```
