...
```{r  label = agency-decline-3, echo = FALSE, fig.cap = "Cumulative number of publications through December (2020-2025) for nine US federal departments or agencies based on first author affiliation. These federal units had the most articles indexed in Scopus from January 2020 through December 2025 (Table 1). The solid lines are each year’s cumulative counts; the dashed line is the 2020-2024 average. Note the different scales of the y-axes for each subplot.", out.width = '105%',fig.align='center'}
# ,out.extra='angle=270'
...
```{r  label = agency-decline-4, echo = FALSE, fig.cap = "Annual percent change in first-author publications for the nine US federal departments or agencies with > 4000  publications indexed in Scopus from January 2020 through December 2025 (Table 1).", out.width = '90%',fig.align='center'}
# ,out.extra='angle=270'
