...
tmp <- knitr::kable(agency_table,
  ...
  row.names = FALSE,
  booktabs = T,
  caption = "The number of publications with at least one federally affiliated author or whose first author is from different units of the US federal government.  Also shown is the percentage of 2019-2025 publications whose first author is from each government unit and the percent difference in first author publications (Jan-July 2025 vs. Jan - July 2024).",
  longtable = F,
  linesep = ""
) %>%
  kable_styling(
