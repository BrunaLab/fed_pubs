...
```{r  label = cumulative-fig-fed, echo = FALSE, fig.cap = "Cumulative number of articles published per month in 2019-2025 (A) whose first-authors were affiliated with the US federal government and (B) for which all authors were affiliated with the US federal government. The solid lines represent the cumulative counts for 2019-2025; the dashed line is the 2019-2024 average. Also shown is the percent change from January-July 2024 to the same time period in 2025.  Note the different scale of the y-axis for panels A and B.", out.width = '75%',out.height = '85%',fig.align='center'}
