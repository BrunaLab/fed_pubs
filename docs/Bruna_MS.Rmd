...
# Publications by US Federal Personnel (Jan 2019 - September 1 2025)
...
fed_dir<-paste("./docs/summary_info/fed_",date,sep="")
uni_dir<-paste("./docs/summary_info/uni_",date,sep="")
...
journals_n_perc_annual_first.csv<-read_csv(paste(fed_dir,"journals_n_perc_annual_first.csv",sep="/"))
...
perc_change_avg<-perc_change_fed_annual %>% filter(PY<2025) %>% summarize(avg=mean(cumul_pubs))
...
<!-- # caption = "The number of publications in  the data set with at least one author from an agency or department of the US federal government (any author position), the number of publications from 2019\\-2025 for which the first author's primary address is the federal department or agency, the number of 1st author publications from January\\-September 2025, and the percent change in productivity relative to the same time period in 2024.", -->
...
```{r pubstable, echo = FALSE, fig.cap="Table 1. The number and percentage of publications indexed in Scopus by federal author affiliation and author position. Also shown is the percent difference in first author publications when comparing Jan-September 2025 with the same period in 2024."}
...
tmp <- knitr::kable(agency_table,
  ...
  row.names = FALSE,
  booktabs = T,
  caption = "The number and percentage of publications indexed in Scopus by federal author affiliation and author position. Also shown is the percent difference in first author publications when comparing Jan-Sept 2025 with the same period in 2024.",
  longtable = F,
  linesep = ""
) %>%
  kable_styling(
...
```{r  label = cumulative-fig-fed, echo = FALSE, fig.cap = "Cumulative number of articles published per month (2019-2025). (A) Articles whose first-authors are affiliated with the US federal government. (B) Articles with all authors having US federal government affiliations. Solid lines represent the cumulative counts for 2019-2025; the dashed line is the 2019-2024 average. Also shown is the percent change in cumulative publications through Sept 2025 vs. the same period in 2024.", out.width = '85%',out.height = '85%',fig.align='center'}
...
```{r  label = agency-decline-3, echo = FALSE, fig.cap = "Cumulative number of publications through Sept (2019-2025) for nine US federal departments or agencies based on first author affiliation. These federal units had the most articles indexed in Scopus from January 2019 through Sept 2025 (Table 1). The solid lines are each year’s cumulative counts; the dashed line is the 2019-2024 average. Note the different scales of the y-axes for each subplot.", out.width = '105%',fig.align='center'}
# ,out.extra='angle=270'
