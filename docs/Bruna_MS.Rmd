...
Here I show that a key indicator of federal research productivity --- the number of peer-reviewed journal articles and book chapters by US federal government affiliates --- has declined precipitously in the first `r as.english(unique(perc_change_fed$PM))` months of 2025 relative to the same time period in any of the preceding `r as.english(nrow(perc_change_fed)-1)` years (Figure \@ref(fig:cumulative-fig-fed)). This conclusion is based on an analysis of the Scopus bibliographic database (https://www.scopus.com), which indexes the content of over 200,000 books and 48,000 journals comprising all major fields of scholarship [@baasScopusCuratedHighquality2020]. While productivity at `r as.english(nrow(uni_names))` of the most productive research universities in the United States has also declined during this time period, the decline in Federal productivity exceeds the collective decline at these universities by ~55% (Table \@ref(tab:pubstable), Figure \@ref(fig:cumulative-fig-uni)).
