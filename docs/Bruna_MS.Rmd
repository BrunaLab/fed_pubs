...
```{r pubstable, echo = FALSE, fig.cap="Table 1. The number and percentage of publications indexed in Scopus by federal author affiliation and author position. Also shown is the percent difference in first author publications when comparing Jan-Oct 2024 with the same period in 2023 and Jan-Oct 2025 with the same period in 2024."}
