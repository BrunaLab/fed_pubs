...
tmp <- knitr::kable(agency_table,
  ...
  kable_styling(
    ...
    latex_options = c("scale_down",
                      "hold_position",
                      extra_css = ".footnote { margin-top: 3em; }"), # Adjust '1em' as needed),
    font_size = 12,
    position = "center"
  ) %>% 
