...
```{r  label = pubs_yr, echo = FALSE, fig.cap = "Publications per year (2019-2024)", out.width = '50%'}
...
```{r  label = pubs_mo_yr_1, echo = FALSE, fig.cap = "Articles per month (2019-2024). Note: the the January-December peaks are likely due to journals journals publishing fewer than 12 issues per year. Smoothed out somewhat by converting to publications per quarter (see below).", out.width = '50%'}
...
```{r  label = pubs_per_quarter_2, echo = FALSE, fig.cap = "Articles per Quarter (2019-2024).", out.width = '50%'}
...
```{r  label = monthly_pubs_1, echo = FALSE, fig.cap = "Monthly publications from January 1 to May 31 (2019-2025).", out.width = '50%'}
...
total_jan_may %>% 
  ...
  gghighlight(PY == 2025)
ggsave("./images/fig_total_to_date_1.png", width = 4, height = 6, units = "cm")
```



```{r  label = fig_total_to_date_1_fig, echo = FALSE, fig.cap = "Monthly publications from January 1 to May 31 (2019-2025).", out.width = '100%'}
...
ggsave("./images/agency_n_decline_sum.png", width = 6, height = 9, units = "cm")
...
```{r  label = agency_n_decline_sum, echo = FALSE, fig.cap = "Percent change in publicaitons (Jan-May) relative to same period prvious year. Only agencies producing over 10000 articles between 2019-2024.", out.width = '60%'}
...
```{r  label = agency_n_decline_2, echo = FALSE, fig.cap = "Percent change in articles published from previous Jan-May (2019-2024).", out.width = '60%'}
...
```{r  label = agency_n_decline_3, echo = FALSE, fig.cap = "Papers Jan-May from agencies producing over 10000 articles (2019-2024).", out.width = '50%'}
